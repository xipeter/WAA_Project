...
<link
	href="<spring:url value='/bootstrap/front/vendor/bootstrap/css/bootstrap.min.css'/>"
	rel="stylesheet">
...
<link
	href="<spring:url value='/bootstrap/front/css/freelancer.min.css'/>"
	rel="stylesheet">
</head>
...
<body id="page-top">
	...
	<div class="container">
		<img class="img-fluid"
			src="<spring:url value='/bootstrap/front/img/profile.png'/>" alt="">
		...
		<div class="row">
			<div class="col-sm-4 portfolio-item">
				<a class="portfolio-link" href="#portfolioModal1"
					...
					src="<spring:url value='/bootstrap/front/img/portfolio/cabin.png'/>"
					alt="">
				</a>
			</div>
			<div class="col-sm-4 portfolio-item">
				<a class="portfolio-link" href="#portfolioModal2"
					...
					src="<spring:url value='/bootstrap/front/img/portfolio/cake.png'/>"
					alt="">
				</a>
			</div>
			<div class="col-sm-4 portfolio-item">
				<a class="portfolio-link" href="#portfolioModal3"
					...
					src="<spring:url  value='/bootstrap/front/img/portfolio/circus.png' />"
					alt="">
				</a>
			</div>
			<div class="col-sm-4 portfolio-item">
				<a class="portfolio-link" href="#portfolioModal4"
					...
					src="<spring:url  value='/bootstrap/front/img/portfolio/game.png' />"
					alt="">
				</a>
			</div>
			<div class="col-sm-4 portfolio-item">
				<a class="portfolio-link" href="#portfolioModal5"
					...
					src="<spring:url  value='/bootstrap/front/img/portfolio/safe.png' />"
					alt="" />
				</a>
			</div>
			<div class="col-sm-4 portfolio-item">
				<a class="portfolio-link" href="#portfolioModal6"
					...
					src="<spring:url  value='/bootstrap/front/img/portfolio/submarine.png' />"
					alt="" />
				</a>
			</div>
		</div>
	...
	<script
		src="<spring:url value='/bootstrap/front/vendor/jquery/jquery.min.js'/>"></script>
	<script
		src="<spring:url value='/bootstrap/front/vendor/bootstrap/js/bootstrap.bundle.min.js'/>"></script>

	<!-- Plugin JavaScript -->
	<script
		src="<spring:url value='/bootstrap/front/vendor/jquery-easing/jquery.easing.min.js'/>"></script>

	<!-- Contact Form JavaScript -->
	<script
		src="<spring:url value='/bootstrap/front/js/jqBootstrapValidation.js'/>"></script>
	<script src="<spring:url value='/bootstrap/front/js/contact_me.js'/>"></script>

	<!-- Custom scripts for this template -->

	<script
		src="<spring:url value='/bootstrap/front/js/freelancer.min.js'/>"></script>
