...
<head>
    ...
    <!-- Morris Charts CSS -->
<link href="<spring:url value='/bootstrap/vendor/morrisjs/morris.css'/>" rel="stylesheet">
    <!-- Custom Fonts -->
    <link href="<spring:url value='/bootstrap/vendor/font-awesome/css/font-awesome.min.css'/>" rel="stylesheet" type="text/css">
...
<body>
    ...
    <!-- Morris Charts JavaScript -->
        ...
        <script src="<spring:url value='/bootstrap/vendor/raphael/raphael.min.js'/>"></script>
    
    
    
            <script src="<spring:url value='/bootstrap/vendor/morrisjs/morris.min.js'/>"></script>
    
 
    
     <script src="<spring:url value='/bootstrap/data/morris-data.js'/>"></script>
